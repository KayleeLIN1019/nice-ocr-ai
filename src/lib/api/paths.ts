...
export const apiPaths = {
  ...
  monthBatches: "/api/month-batches",
  monthBatch: (id: string) => `/api/month-batches/${id}`,
  documentAudit: (id: string) => `/api/documents/${id}/audit`,
  rows: "/api/rows",
  row: (id: string) => `/api/rows/${id}`,
  rowsBulkConfirm: "/api/rows/bulk-confirm",
  rowsClearShortCodes: "/api/rows/clear-short-codes",
  rowsReplaceProductCode: "/api/rows/replace-product-code",
  rowsReplaceProductName: "/api/rows/replace-product-name",
  suggest: "/api/suggest",
  ...
  reviewBulkSuggestionsApply: "/api/review/bulk-suggestions/apply",
